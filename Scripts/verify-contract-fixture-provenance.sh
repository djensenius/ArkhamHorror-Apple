...
question-investigate-fast-window.json:contracts/fixtures/question-investigate-fast-window.json
...
question-presentation-encounter-deck-draw.json:contracts/fixtures/question-presentation-encounter-deck-draw.json
...
question-cover-up-reaction.json:contracts/fixtures/question-cover-up-reaction.json
