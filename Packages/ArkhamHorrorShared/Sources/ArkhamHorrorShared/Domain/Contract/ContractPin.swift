...
///
/// - Backend PRs: djensenius/ArkhamHorror#20, #22, #24, #45, #49, #51
/// - Backend commit: `52c7ee3b730c87129907e26b91acc3933da841cd`
...
extension ContractPin {
    ...
    ///
    /// Pinned to backend commit `52c7ee3b` (through PR #51), which publishes The
    /// Gathering's opening `Read`/`ChooseOne(LocationTarget)` prompt contract slice and
    /// advances schema to `0.1.22`.
    static let current = ContractPin(
        backendCommit: "52c7ee3b730c87129907e26b91acc3933da841cd",
