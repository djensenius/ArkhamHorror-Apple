...
///   #62, #65, #66, #68, #70, #72, #75, #76, #78, #79, #81, #83, #85, #87, #89
/// - Backend commit: `503e3e4c8cdf8370cba78ac0397e3a2e5c7eee8a`
...
extension ContractPin {
    ...
    ///
    /// Contract revision `0.1.41` governs player-keyed question presentation metadata.
    /// Native semantic question presentation requires server revision `0.1.41`.
    static let current = ContractPin(
        backendCommit: "503e3e4c8cdf8370cba78ac0397e3a2e5c7eee8a",
        supportedSchemaRevision: .literal(major: 0, minor: 1, patch: 41),
        minimumServerSchemaRevision: .literal(major: 0, minor: 1, patch: 41),
