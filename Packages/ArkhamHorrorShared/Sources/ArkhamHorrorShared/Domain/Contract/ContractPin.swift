...
///   #62, #65, #66, #68, #70, #72, #75, #76, #78, #79, #81, #83, #85
/// - Backend commit: `1f73f580fd21cbbc30f70d50dd26949eef8d8ff3`
...
extension ContractPin {
    ...
    ///
    /// Contract revision `0.1.39` governs Roland Banks's post-defeat reaction.
    /// Native Roland-reaction choices require server revision `0.1.39`.
    static let current = ContractPin(
        backendCommit: "1f73f580fd21cbbc30f70d50dd26949eef8d8ff3",
        supportedSchemaRevision: .literal(major: 0, minor: 1, patch: 39),
        minimumServerSchemaRevision: .literal(major: 0, minor: 1, patch: 39),
