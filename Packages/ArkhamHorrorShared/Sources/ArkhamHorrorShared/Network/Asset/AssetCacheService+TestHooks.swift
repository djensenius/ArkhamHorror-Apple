...
extension AssetCacheService {
    ...
    /// Test-only: installs ``testOnlyPauseBeforePublishFinalCAS``.
    func installTestOnlyPauseBeforePublishFinalCAS(_ hook: @escaping () async -> Void) {
        testOnlyPauseBeforePublishFinalCAS = hook
    }
